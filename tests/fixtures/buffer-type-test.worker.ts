...
export class BufferTypeTestWorker {
  ...
  @WorkerMethod()
  readSharedArrayBuffer(sab: SharedArrayBuffer): { value: number; count?: number } {
    const view = new Uint8Array(sab);
    const value = view[0];
  ...
  readComplexCustomData(
    ...
    return {
      ...
      sharedByte0: data.sharedBuffer ? new Uint8Array(data.sharedBuffer)[0] : undefined,
      sharedByte15: data.sharedBuffer ? new Uint8Array(data.sharedBuffer)[15] : undefined,
  ...
  readDataContainer(
    ...
    return {
      ...
      sharedByte0: container.shared ? new Uint8Array(container.shared)[0] : undefined,
      sharedByte31: container.shared ? new Uint8Array(container.shared)[31] : undefined,
